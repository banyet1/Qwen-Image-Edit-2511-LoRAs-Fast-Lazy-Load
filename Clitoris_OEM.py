...
ADAPTER_SPECS = {
    ...
    "lock": {
        "url": "https://ai.x39.org/lora/lock.safetensors",
        "repo": LORA_DIR,
        "weights": "lock.safetensors",
        "adapter_name": "lock",
    },
    "beer": {
    ...
    "Clitoris": {
        "url": "https://ai.x39.org/lora/clitoris25.safetensors",
        "repo": LORA_DIR,
        "weights": "clitoris25.safetensors",
        "adapter_name": "Clitoris",
    },
    "Shaved": {
        "url": "https://ai.x39.org/lora/shaved25.safetensors",
        "repo": LORA_DIR,
        "weights": "shaved25.safetensors",
        "adapter_name": "Shaved",
    },
    "CNPussy/Shaved/Clitoris": {
        "combo": ["CNPussy", "Shaved", "Clitoris"],
        # "combo": ["Clitoris"],
        "adapter_weights": [0.4, 0.3, 0.3],
    },
    "Shaved/Clitoris": {
...
EXAMPLES_CONFIG = [
    ...
    {"images": ["examples/asiawomen.jpg"],                        "prompt": "zl_cn_female_genitals_v1, zl_cn_female_clitoris_v1, zl_cn_female_clitoris_v1， full nude, 躺着，腿分开, 头扭向侧面，低头，expose pussy, expose asshole, expose clitoris, direct view.",                                                                                           "lora": "CNPussy/Shaved/Clitoris"},
    {"images": ["examples/asiawomen.jpg"],                        "prompt": "zzl_cn_female_shaved_genitals_v1, zl_cn_female_clitoris_v1, full nude, 乳房很大，跪着，她自己用双手分开pussy, expose pussy, expose asshole, expose clitoris, 扭头看镜头,rear view.",                                                                                           "lora": "Shaved/Clitoris"},
